package com.robin.elasticsearchjest;

import com.robin.elasticsearchjest.common.elasticsearch.base.ESPageResult;
import com.robin.elasticsearchjest.dao.GoodsESDao;
...
class GoodsESDaoTest {
    ...
    public void searchListByAnalysisTest() {
        List<GoodsESEntity> goodsESEntityList = goodsESDao.findListByAnalysisForGroupData("保时捷跑车V20");
